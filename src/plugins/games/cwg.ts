...
class Cwg {
	...
	private calculatePoints(): number {
		const basePoints =
			this.missingLetters <= 2
				...
				: Math.min(20 + this.missingLetters * 10, 80);
		return Math.floor(basePoints * (this.currentWord.length / 5));
	}
	...
	private getCurrentTimeout(): number {
		if (this.missingLetters === 1) this.currentTimeout = 35000;
		else if (this.missingLetters === 2) this.currentTimeout = 30000;
		else if (this.missingLetters === 3) this.currentTimeout = 25000;
		else if (this.missingLetters === 4) this.currentTimeout = 22000;
		else this.currentTimeout = 18000;
