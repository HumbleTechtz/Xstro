...
import { getDataType } from "./content.js";
import { commands } from "../messaging/plugin.js";
...
export async function prepareMessage(client, content, options) {
...
export async function forwardM(client, jid, message, options) {
    return await client.sendMessage(jid, {
        forward: message,
        contextInfo: { ...options },
    }, { quoted: options?.quoted });
}
export async function sendPayloadBootMsg(client) {
